...
export function ProjectCard({ title, description, technologies, githubUrl, demoUrl, media, projectId }: ProjectCardProps) {
  ...
  const technologyTooltips: Record<string, string> = {
    ...
    'libtorch': 'Biblioteca C++ de PyTorch para deep learning',
    'PyTorch': 'Framework de deep learning dinámico y flexible',
    'Vision Transformer': 'Arquitectura de transformers aplicada a visión computacional',
    'MNIST': 'Dataset de dígitos manuscritos para clasificación',
    'Fashion-MNIST': 'Dataset de prendas de vestir para clasificación de imágenes',
